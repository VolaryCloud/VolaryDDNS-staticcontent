...
document.addEventListener('DOMContentLoaded', function() {
    ...
    downloadButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            modal.innerHTML = `
                <div class="mb-4">
                    <h3 class="text-lg font-medium text-gray-900">Choose your operating system</h3>
                    <p class="text-sm text-gray-500 mt-1">Select the operating system where you'll run the update script</p>
                </div>
                <div class="space-y-4">
                    <a href="/download-script/unix/${subdomainId}" class="flex items-center p-3 border rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-900">Unix-like Systems</p>
                            <p class="text-xs text-gray-500">Linux, macOS, Raspberry Pi</p>
                        </div>
                    </a>
                    <a href="/download-script/windows/${subdomainId}" class="flex items-center p-3 border rounded-lg hover:bg-gray-50 transition-colors">
                        <div class="flex-shrink-0 text-primary-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-xs text-gray-500">Windows 10/11</p>
                        </div>
                    </a>
                </div>
                <div class="mt-5 flex justify-end">
                    <button type="button" class="cancel-btn mt-3 px-4 py-2 bg-white text-gray-700 hover:bg-gray-50 border border-gray-300 rounded-md shadow-sm text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                        Cancel
                    </button>
                </div>
                `;
